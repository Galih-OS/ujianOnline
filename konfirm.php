...
// echo "SELECT * FROM  `cbt_siswa` WHERE XNomerUjian = '$txtuser' and XPassword = '$txtpass' $_COOKIE[PESERTA] | $_COOKIE[KUNCI]";
 ...
 $sqlta = mysql_query("SELECT * FROM  `cbt_setid` WHERE XStatus = '1'");
 $res = mysql_fetch_array($sqlta);
 $ta = $res['XKodeAY'];
...
and u.XStatusUjian = '1'");
  ...
  $XKodeUjian = $s['XKodeUjian'];
  $XSemester = $s['XSemester'];
...
<div class="group">
    <div class="left" style="background-color:<?php echo "$r[XWarna]"; ?>"><a href="http://tuwagapat.com"><img src="images/<?php echo "$r[XBanner]"; ?>" style=" margin-left:0px;"></a>
    	...
    	<div class="right"><table width="100%" border="0" cellspacing="5px;" style="margin-top:10px">   
						...
						<td><span  style=" margin-left:0px; margin-top:5px">Selamat Datang | <?php echo $TahunAjaran; ?></span></td></tr>
...
if($sqlcekujian>0){ ?>
                ...
                <div class="list-group-item">
                    ...
                    <p class="list-group-item-text"><?php echo "$xnamamapel".' | '. "$XKodeUjian". ' | '. "$ta". ' | Semester : '. "$XSemester" ?></p>

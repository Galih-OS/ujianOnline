...
<div class="group">
    <div class="left" style="background-color:<?php echo "$r[XWarna]"; ?>"><a href="login.php"><img src="images/<?php echo "$r[XBanner]"; ?>" style=" margin-left:0px;"></a>
		...
		<?php
			$s = mysql_query("SELECT XNamaAY as wk FROM cbt_setid WHERE XStatus='1'");
						$wl = mysql_fetch_array($s);
						$TahunAjaran= $wl['wk'];
		?>
    	<div class="right"><table width="100%" border="0" style="margin-top:10px">   
						...
						<td>Selamat Datang | <?php echo $TahunAjaran; ?></td></tr>
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<ul class="nav nav-tabs" id="myTab">
				...
				<li><a data-toggle="tab" href="#akademik">Histori Akademik</a></li>
			</ul>
			<div class="tab-content"><br>
				...
				<div id="akademik" class="tab-pane fade">
					<form action="akademik/home.php" method="post" data-toggle="validator" id="form1" ><input  type="hidden">
						<div class="form-horizontal" style="margin-top:30px"><br>
							<div class="form-group error" >
								<label class="col-sm-3 control-label" for="UserName">Username</label>
								<div class="col-sm-8 input-wrapper">

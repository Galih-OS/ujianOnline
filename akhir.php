...
$xjumbenarz = mysql_query("select count(XNilai) as benar from cbt_jawaban where XUserJawab = '$user' and XJenisSoal = '1' and XKodeSoal = '$xkodesoal' and XTokenUjian = '$xtokenujian' and XNilai = '1'");
		  ...
		  $sql_TA = mysql_query("SELECT XKodeAY FROM cbt_setid WHERE XStatus='1'");
						...
						<div class="inner-content">
                            <div class="wysiwyg-content">
                                <p>
									...
									<b>Jumlah Nilai Pilihan Ganda Anda <br><br>
									<p style="font-size:82px" id="nilaiskor"> <?php echo round($nilaix, 2); ?> </p><br>
									Untuk Essai, mohon ditunggu atau silahkan cek pada halaman Laporan Nilai Siswa. Terima Kasih</b>
                                </p>
                            </div>
                        </div>
						<br>

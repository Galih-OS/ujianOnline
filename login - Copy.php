...
<html class="no-js" lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>UJIAN ONLINE SMK IPIEMS</title>
...
<div class="group">
    <div class="left" style="background-color:<?php echo "$r[XWarna]"; ?>"><a href="login.php"><img src="images/<?php echo "$r[XBanner]"; ?>" style=" margin-left:0px;"></a>
    </div>
...
<div class="col-md-6 col-md-offset-3 login-wrapper" id="" style="float:inherit; margin-top:0px; min-width:400px;" id="">
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<ul class="nav nav-tabs" id="myTab">
				<li class="active"><a data-toggle="tab" href="#ujian">Ujian</a></li>
				<li><a data-toggle="tab" href="#eresources">e-Resources</a></li>
				<li><a data-toggle="tab" href="#laporan">Laporan Nilai</a></li>
				<li><a data-toggle="tab" href="#jadwal">Jadwal Ujian</a></li>
				<li><a data-toggle="tab" href="#daftar">Review Hasil Dan Soal</a></li>
			</ul>
			<div class="tab-content"><br>
				...
				<div id="eresources" class="tab-pane fade">
					<form action="eresources.php" method="post" data-toggle="validator" id="form1" ><input  type="hidden">
						<div class="form-horizontal" style="margin-top:30px"><br>
							<div class="form-group error" >
								<label class="col-sm-3 control-label" for="UserName">Username</label>
								<div class="col-sm-8 input-wrapper">
				...
				<div id="laporan" class="tab-pane fade">
					<form action="laporan.php" method="post" data-toggle="validator" id="form1" ><input  type="hidden">
						<div class="form-horizontal" style="margin-top:30px"><br>
							<div class="form-group error" >
								<label class="col-sm-3 control-label" for="UserName">Username</label>
								<div class="col-sm-8 input-wrapper">
				...
				<div id="jadwal" class="tab-pane fade">
					<form action="jadwal.php" method="post" data-toggle="validator" id="form1" ><input  type="hidden">
						<!-- <div class="form-horizontal" style="overflow-y:scroll; overflow-x:hidden; height:200px; margin-top:30px"><br> -->
						<div class="form-horizontal" style="margin-top:30px"><br>
							<div class="form-group error" >
								<label class="col-sm-3 control-label" for="UserName">Username</label>
								<div class="col-sm-8 input-wrapper">
					...
					<!-- <h2><center>Download Jadwal Ujian Praktikum</center></h2>
				...
				<div id="daftar" class="tab-pane fade">
					<form action="panel/pages/analisa_soal_siswa.php" method="post" data-toggle="validator" id="form1" ><input  type="hidden">
						<div class="form-horizontal" style="margin-top:30px"><br>
							<div class="form-group error" >
								<label class="col-sm-3 control-label" for="UserName">Username</label>
								<div class="col-sm-8 input-wrapper">
...
<footer>
    <div class="container" style=" font-size:12px">
        <p><?php echo strtoupper("$r[XSekolah]"); ?> | &COPY Galih-OS</p>
    </div>
</footer>

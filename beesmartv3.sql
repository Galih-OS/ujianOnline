...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 23, 2018 at 02:24 PM
...
--
-- Table structure for table `cbt_guru_mapel`
--

CREATE TABLE IF NOT EXISTS `cbt_guru_mapel` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `XGuru` varchar(20) NOT NULL,
  `XKodeKelas` varchar(20) NOT NULL,
...
--
-- Dumping data for table `cbt_guru_mapel`
--

INSERT INTO `cbt_guru_mapel` (`ID`, `XGuru`, `XKodeKelas`, `XKodeMapel`, `XKodeAY`) VALUES
(1, 'guru1', 'X-DKV-1', 'Fisika', '2017/2018'),
(2, 'guru1', 'X-DKV-1', 'IPS', '2017/2018');
...
CREATE TABLE IF NOT EXISTS `cbt_jawaban` (
  ...
  PRIMARY KEY (`Urutan`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci AUTO_INCREMENT=455 ;
...
CREATE TABLE IF NOT EXISTS `cbt_siswa` (
  ...
  `XGuruWali` varchar(10) COLLATE latin1_general_ci DEFAULT NULL,
  PRIMARY KEY (`Urut`)
...
INSERT INTO `cbt_siswa` (`Urut`, `XNomerUjian`, `XNIK`, `XKodeJurusan`, `XNamaSiswa`, `XKodeKelas`, `XKodeLevel`, `XJenisKelamin`, `XPassword`, `XFoto`, `XAgama`, `XSetId`, `XSesi`, `XRuang`, `XKodeSekolah`, `XPilihan`, `XGuruWali`) VALUES
(390, 'U035', '1151/929.073', 'MM', 'ACHMAD FAUZI', 'X-MM-2', 'X-MM', 'L', 'A34', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(391, 'U036', '1151/929.074', 'MM', 'ADIMAS TEGAR PUTRA SUMITRA', 'X-MM-2', 'X-MM', 'L', 'A35', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(392, 'U037', '1151/929.075', 'MM', 'AGENG SAVIRGO KARYATIO', 'X-MM-2', 'X-MM', 'L', 'A36', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(393, 'U038', '1151/929.076', 'MM', 'AMELIA EL FATHUL SYAFITRI', 'X-MM-2', 'X-MM', 'P', 'A37', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(394, 'U039', '1151/929.077', 'MM', 'ANNISA RUSMIATI', 'X-MM-2', 'X-MM', 'P', 'A38', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(395, 'U040', '1151/929.078', 'MM', 'ARIF MA`RUF HIDAYAH', 'X-MM-2', 'X-MM', 'L', 'A39', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(396, 'U041', '1151/929.079', 'MM', 'ARIO MAULANA', 'X-MM-2', 'X-MM', 'L', 'A40', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(397, 'U042', '1151/929.080', 'MM', 'BIMA PERSADA ARIES FIANTONO', 'X-MM-2', 'X-MM', 'L', 'A41', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(398, 'U043', '1151/929.081', 'MM', 'BIMASAKTI ASNAWAN PUTRA', 'X-MM-2', 'X-MM', 'L', 'A42', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(399, 'U044', '1151/929.082', 'MM', 'CELVIN ADITYA', 'X-MM-2', 'X-MM', 'L', 'A43', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(400, 'U045', '1151/929.083', 'MM', 'Daffa Imana Indrastadika', 'X-MM-2', 'X-MM', 'L', 'A44', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(401, 'U046', '1151/929.084', 'MM', 'DICKY SETIAWAN', 'X-MM-2', 'X-MM', 'L', 'A45', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(402, 'U047', '1151/929.085', 'MM', 'DIMAS RENDI ADI SUSANTO', 'X-MM-2', 'X-MM', 'L', 'A46', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(403, 'U048', '1151/929.086', 'MM', 'DWI ANANDA PRIHARYANTO', 'X-MM-2', 'X-MM', 'L', 'A47', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(404, 'U049', '1151/929.087', 'MM', 'FARID JULIAN ANUGRAH', 'X-MM-2', 'X-MM', 'L', 'A48', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(405, 'U050', '1151/929.088', 'MM', 'HANIS RAMADHAN', 'X-MM-2', 'X-MM', 'L', 'A49', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(406, 'U051', '1151/929.089', 'MM', 'HANNA MACHFIROH', 'X-MM-2', 'X-MM', 'P', 'A50', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(407, 'U052', '1151/929.090', 'MM', 'Helmi Fauzan Rahadi', 'X-MM-2', 'X-MM', 'L', 'A51', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(408, 'U053', '1151/929.091', 'MM', 'IRICO FEBRIANSAH', 'X-MM-2', 'X-MM', 'L', 'A52', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(409, 'U054', '1151/929.092', 'MM', 'KEMAL PASHA FADILLA UMAR', 'X-MM-2', 'X-MM', 'L', 'A53', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(410, 'U055', '1151/929.093', 'MM', 'MUH. YUNUS ARDIANSYAH', 'X-MM-2', 'X-MM', 'L', 'A54', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(411, 'U056', '1151/929.094', 'MM', 'MUHAMMAD BENY AFDILLAH', 'X-MM-2', 'X-MM', 'L', 'A55', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(412, 'U057', '1151/929.095', 'MM', 'NAVITA PUTRI AGUSTIN', 'X-MM-2', 'X-MM', 'P', 'A56', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(413, 'U058', '1151/929.096', 'MM', 'NOVA DWI MAHENDRA', 'X-MM-2', 'X-MM', 'L', 'A57', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(414, 'U059', '1151/929.097', 'MM', 'NUR BAETI', 'X-MM-2', 'X-MM', 'P', 'A58', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(415, 'U060', '1151/929.098', 'MM', 'RAJENDRA AIRLIAN ARIPUTRA', 'X-MM-2', 'X-MM', 'L', 'A59', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(416, 'U061', '1151/929.099', 'MM', 'RAYHANSYAH MAULANA RIZKIAWAN', 'X-MM-2', 'X-MM', 'L', 'A60', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(417, 'U062', '1151/929.100', 'MM', 'RENDI FEBIO PUTRA', 'X-MM-2', 'X-MM', 'L', 'A61', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(418, 'U063', '1151/929.101', 'MM', 'RIZAL ABIDIN', 'X-MM-2', 'X-MM', 'L', 'A62', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(419, 'U064', '1151/929.102', 'MM', 'ROBBIL GEO SANDY', 'X-MM-2', 'X-MM', 'L', 'A63', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(420, 'U065', '1151/929.103', 'MM', 'RYAN AJI SAPUTRA', 'X-MM-2', 'X-MM', 'L', 'A64', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(421, 'U066', '1151/929.104', 'MM', 'SEPTIANI TRI ANJARWATI', 'X-MM-2', 'X-MM', 'P', 'A65', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(422, 'U067', '1151/929.105', 'MM', 'TRI PURNAMA EKA PUTRA', 'X-MM-2', 'X-MM', 'L', 'A66', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(423, 'U068', '1151/929.106', 'MM', 'VONNY IFTITAH PUTRI', 'X-MM-2', 'X-MM', 'P', 'A67', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(424, 'U069', '1151/929.107', 'MM', 'WILDA SARI BASRI', 'X-MM-2', 'X-MM', 'P', 'A68', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(425, 'U070', '1151/929.108', 'MM', 'YESI QUR`NIASARI', 'X-MM-2', 'X-MM', 'P', 'A69', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(426, 'U071', '1151/929.109', 'MM', 'ZAKARIA', 'X-MM-2', 'X-MM', 'L', 'A70', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(357, 'U002', '1199/250/085', 'DKV', 'ADE SAFRIL WAHYU PRADHANA', 'X-DKV-1', 'X-DKV', 'L', 'A2', '', '', '2016/2017', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(358, 'U003', '1199/250/086', 'DKV', 'ADINDA THALIA SARI', 'X-DKV-1', 'X-DKV', 'P', 'A3', '', '', '2016/2017', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(359, 'U004', '1199/250/087', 'DKV', 'ADITYA WISNU PRATAM', 'X-DKV-1', 'X-DKV', 'L', 'A4', '', '', '2016/2017', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(360, 'U005', '1199/250/088', 'DKV', 'ADREAYAN CANDANI PUTRA', 'X-DKV-1', 'X-DKV', 'L', 'A5', '', '', '2016/2017', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(361, 'U006', '1199/250/089', 'DKV', 'ALAMSYAH ABDILAH', 'X-DKV-1', 'X-DKV', 'L', 'A6', '', '', '2016/2017', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(362, 'U007', '1199/250/090', 'DKV', 'ALDY NOVI ANSYAH', 'X-DKV-1', 'X-DKV', 'L', 'A7', '', '', '2016/2017', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(363, 'U008', '1199/250/091', 'DKV', 'ALDY RISTIOVAN', 'X-DKV-1', 'X-DKV', 'L', 'A8', '', '', '2016/2017', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(364, 'U009', '1199/250/092', 'DKV', 'ANGELIA SHAVIRA PUTRI SOPHITA', 'X-DKV-1', 'X-DKV', 'P', 'A9', '', '', '2016/2017', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(365, 'U010', '1199/250/093', 'DKV', 'ARYO PHRAMUDHITO', 'X-DKV-1', 'X-DKV', 'L', 'A10', '', '', '2016/2017', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(366, 'U011', '1199/250/094', 'DKV', 'AZIZAH YASMIN', 'X-DKV-1', 'X-DKV', 'P', 'A11', '', '', '2016/2017', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(367, 'U012', '1199/250/095', 'DKV', 'BAGAS FITRA WARDANIANSYAG', 'X-DKV-1', 'X-DKV', 'L', 'A12', '', '', '2016/2017', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(368, 'U013', '1199/250/096', 'DKV', 'CITRA AYU DAMAYANTI KUSWOYO', 'X-DKV-1', 'X-DKV', 'P', 'A13', '', '', '2016/2017', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(369, 'U014', '1199/250/097', 'DKV', 'DANDY FAJAR PRIAMBODO', 'X-DKV-1', 'X-DKV', 'L', 'A14', '', '', '2016/2017', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(370, 'U015', '1199/250/098', 'DKV', 'HARYO YUDO SENO', 'X-DKV-1', 'X-DKV', 'L', 'A15', '', '', '2016/2017', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(371, 'U016', '1199/250/099', 'DKV', 'JEREMY ADRIEL OENTORO', 'X-DKV-1', 'X-DKV', 'L', 'A16', '', '', '2016/2017', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(372, 'U017', '1199/250/100', 'DKV', 'MOCH. FIQRI IVANSYAH', 'X-DKV-1', 'X-DKV', 'L', 'A17', '', '', '2016/2017', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(373, 'U018', '1199/250/101', 'DKV', 'MUHAMMAD ANDHIKA ARYA PUTRA', 'X-DKV-1', 'X-DKV', 'L', 'A18', '', '', '2016/2017', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(374, 'U019', '1199/250/102', 'DKV', 'MUHAMMAD RIZKY ARYANTO', 'X-DKV-1', 'X-DKV', 'L', 'A19', '', '', '2016/2017', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(375, 'U020', '1199/250/103', 'DKV', 'NADYA AUDI AMARTHA', 'X-DKV-1', 'X-DKV', 'P', 'A20', '', '', '2016/2017', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(376, 'U021', '1199/250/104', 'DKV', 'NINDA IKA MARET NAWATI', 'X-DKV-1', 'X-DKV', 'P', 'A21', '', '', '2016/2017', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(377, 'U022', '1199/250/105', 'DKV', 'ODIEK DARMAWAN', 'X-DKV-1', 'X-DKV', 'L', 'A22', '', '', '2016/2017', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(378, 'U023', '1199/250/106', 'DKV', 'OTRI FATHIN NAUFAL WIDJANARKO', 'X-DKV-1', 'X-DKV', 'L', 'A23', '', '', '2016/2017', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(379, 'U024', '1199/250/107', 'DKV', 'QIMAS GUSTI PRAYOGO', 'X-DKV-1', 'X-DKV', 'L', 'A24', '', '', '2016/2017', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(380, 'U025', '1199/250/108', 'DKV', 'RACHMAD RIZKY SEPTIAWAN', 'X-DKV-1', 'X-DKV', 'L', 'A25', '', '', '2016/2017', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(381, 'U026', '1199/250/109', 'DKV', 'REZTA AULIA AZMI', 'X-DKV-1', 'X-DKV', 'P', 'A26', '', '', '2016/2017', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(382, 'U027', '1199/250/110', 'DKV', 'RINDI ANTIKA', 'X-DKV-1', 'X-DKV', 'P', 'A27', '', '', '2016/2017', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(383, 'U028', '1199/250/111', 'DKV', 'RISKA MARDYA PUTRI', 'X-DKV-1', 'X-DKV', 'P', 'A28', '', '', '2016/2017', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(384, 'U029', '1199/250/112', 'DKV', 'SHEKINAH GLORIA PANGALILA', 'X-DKV-1', 'X-DKV', 'P', 'A29', '', '', '2016/2017', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(385, 'U030', '1199/250/113', 'DKV', 'SISKA NUR CAHYANI', 'X-DKV-1', 'X-DKV', 'P', 'A30', '', '', '2016/2017', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(386, 'U031', '1199/250/114', 'DKV', 'SITI NUR`AINI', 'X-DKV-1', 'X-DKV', 'P', 'A31', '', '', '2016/2017', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(387, 'U032', '1199/250/115', 'DKV', 'YUNITA NOVIYATU SUGIANTO PUTRI', 'X-DKV-1', 'X-DKV', 'P', 'A32', '', '', '2016/2017', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(388, 'U033', '1199/250/116', 'DKV', 'YURI ZAIDAN KHAIRULLAH', 'X-DKV-1', 'X-DKV', 'L', 'A33', '', '', '2016/2017', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(389, 'U034', '1151/929.072', 'MM', 'RIZQI NAUFAL HARIANTO', 'X-MM-2', 'X-MM', 'L', 'A33', '', '', '2016/2017', 2, 'LABKOM-C', 'P9999991', '', NULL),
(356, 'U001', '1199/250/084', 'DKV', 'PAUNDRA UGRASHENA', 'X-DKV-1', 'X-DKV', 'L', 'A1', '', '', '2016/2017', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(427, 'U001', '1199/250/084', 'DKV', 'PAUNDRA UGRASHENA', 'X-DKV-1', 'X-DKV', 'L', 'A1', '', '', '2017/2018', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(428, 'U002', '1199/250/085', 'DKV', 'ADE SAFRIL WAHYU PRADHANA', 'X-DKV-1', 'X-DKV', 'L', 'A2', '', '', '2017/2018', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(429, 'U003', '1199/250/086', 'DKV', 'ADINDA THALIA SARI', 'X-DKV-1', 'X-DKV', 'P', 'A3', '', '', '2017/2018', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(430, 'U004', '1199/250/087', 'DKV', 'ADITYA WISNU PRATAM', 'X-DKV-1', 'X-DKV', 'L', 'A4', '', '', '2017/2018', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(431, 'U005', '1199/250/088', 'DKV', 'ADREAYAN CANDANI PUTRA', 'X-DKV-1', 'X-DKV', 'L', 'A5', '', '', '2017/2018', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(432, 'U006', '1199/250/089', 'DKV', 'ALAMSYAH ABDILAH', 'X-DKV-1', 'X-DKV', 'L', 'A6', '', '', '2017/2018', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(433, 'U007', '1199/250/090', 'DKV', 'ALDY NOVI ANSYAH', 'X-DKV-1', 'X-DKV', 'L', 'A7', '', '', '2017/2018', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(434, 'U008', '1199/250/091', 'DKV', 'ALDY RISTIOVAN', 'X-DKV-1', 'X-DKV', 'L', 'A8', '', '', '2017/2018', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(435, 'U009', '1199/250/092', 'DKV', 'ANGELIA SHAVIRA PUTRI SOPHITA', 'X-DKV-1', 'X-DKV', 'P', 'A9', '', '', '2017/2018', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(436, 'U010', '1199/250/093', 'DKV', 'ARYO PHRAMUDHITO', 'X-DKV-1', 'X-DKV', 'L', 'A10', '', '', '2017/2018', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(437, 'U011', '1199/250/094', 'DKV', 'AZIZAH YASMIN', 'X-DKV-1', 'X-DKV', 'P', 'A11', '', '', '2017/2018', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(438, 'U012', '1199/250/095', 'DKV', 'BAGAS FITRA WARDANIANSYAG', 'X-DKV-1', 'X-DKV', 'L', 'A12', '', '', '2017/2018', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(439, 'U013', '1199/250/096', 'DKV', 'CITRA AYU DAMAYANTI KUSWOYO', 'X-DKV-1', 'X-DKV', 'P', 'A13', '', '', '2017/2018', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(440, 'U014', '1199/250/097', 'DKV', 'DANDY FAJAR PRIAMBODO', 'X-DKV-1', 'X-DKV', 'L', 'A14', '', '', '2017/2018', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(441, 'U015', '1199/250/098', 'DKV', 'HARYO YUDO SENO', 'X-DKV-1', 'X-DKV', 'L', 'A15', '', '', '2017/2018', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(442, 'U016', '1199/250/099', 'DKV', 'JEREMY ADRIEL OENTORO', 'X-DKV-1', 'X-DKV', 'L', 'A16', '', '', '2017/2018', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(443, 'U017', '1199/250/100', 'DKV', 'MOCH. FIQRI IVANSYAH', 'X-DKV-1', 'X-DKV', 'L', 'A17', '', '', '2017/2018', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(444, 'U018', '1199/250/101', 'DKV', 'MUHAMMAD ANDHIKA ARYA PUTRA', 'X-DKV-1', 'X-DKV', 'L', 'A18', '', '', '2017/2018', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(445, 'U019', '1199/250/102', 'DKV', 'MUHAMMAD RIZKY ARYANTO', 'X-DKV-1', 'X-DKV', 'L', 'A19', '', '', '2017/2018', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(446, 'U020', '1199/250/103', 'DKV', 'NADYA AUDI AMARTHA', 'X-DKV-1', 'X-DKV', 'P', 'A20', '', '', '2017/2018', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(447, 'U021', '1199/250/104', 'DKV', 'NINDA IKA MARET NAWATI', 'X-DKV-1', 'X-DKV', 'P', 'A21', '', '', '2017/2018', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(448, 'U022', '1199/250/105', 'DKV', 'ODIEK DARMAWAN', 'X-DKV-1', 'X-DKV', 'L', 'A22', '', '', '2017/2018', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(449, 'U023', '1199/250/106', 'DKV', 'OTRI FATHIN NAUFAL WIDJANARKO', 'X-DKV-1', 'X-DKV', 'L', 'A23', '', '', '2017/2018', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(450, 'U024', '1199/250/107', 'DKV', 'QIMAS GUSTI PRAYOGO', 'X-DKV-1', 'X-DKV', 'L', 'A24', '', '', '2017/2018', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(451, 'U025', '1199/250/108', 'DKV', 'RACHMAD RIZKY SEPTIAWAN', 'X-DKV-1', 'X-DKV', 'L', 'A25', '', '', '2017/2018', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(452, 'U026', '1199/250/109', 'DKV', 'REZTA AULIA AZMI', 'X-DKV-1', 'X-DKV', 'P', 'A26', '', '', '2017/2018', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(453, 'U027', '1199/250/110', 'DKV', 'RINDI ANTIKA', 'X-DKV-1', 'X-DKV', 'P', 'A27', '', '', '2017/2018', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(454, 'U028', '1199/250/111', 'DKV', 'RISKA MARDYA PUTRI', 'X-DKV-1', 'X-DKV', 'P', 'A28', '', '', '2017/2018', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(455, 'U029', '1199/250/112', 'DKV', 'SHEKINAH GLORIA PANGALILA', 'X-DKV-1', 'X-DKV', 'P', 'A29', '', '', '2017/2018', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(456, 'U030', '1199/250/113', 'DKV', 'SISKA NUR CAHYANI', 'X-DKV-1', 'X-DKV', 'P', 'A30', '', '', '2017/2018', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(457, 'U031', '1199/250/114', 'DKV', 'SITI NUR`AINI', 'X-DKV-1', 'X-DKV', 'P', 'A31', '', '', '2017/2018', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(458, 'U032', '1199/250/115', 'DKV', 'YUNITA NOVIYATU SUGIANTO PUTRI', 'X-DKV-1', 'X-DKV', 'P', 'A32', '', '', '2017/2018', 1, 'LABKOM-A', 'P9999991', '', 'wakel1'),
(459, 'U033', '1199/250/116', 'DKV', 'YURI ZAIDAN KHAIRULLAH', 'X-DKV-1', 'X-DKV', 'L', 'A33', '', '', '2017/2018', 1, 'LABKOM-A', 'P9999991', '', 'wakel1');
...
(17, 'wakel1', '0d42ab4bd6a30299f63a0b87198d6d5c', '13410100070', 'Yoga, S.Pd', 'wakel', '089788987675', 'yoga@gmail.com', 0, '0'),
...
(25, 'agit', '202cb962ac59075b964b07152d234b70', '123', 'Agit', 'admin', '123', '123', 1, '1'),
(122, 'admin', '21232f297a57a5a743894a0e4a801fc3', '13410100068', 'admin', 'admin', '1', '1@gmail.com', 1, '1'),
(123, 'admin', '21232f297a57a5a743894a0e4a801fc3', '13410100068', 'admin', 'admin', '1', '1@gmail.com', 0, '1'),
(124, 'komang1', 'c4373af13ebf8e3df93c2add6e05205a', '13410100069', 'komang1', 'kepsek', '2', '2@gmail.com', 0, '1'),
(125, 'komang2', 'cbdef04ef5444eb8fecad9b49210ef5b', '13410100070', 'komang2', 'waka', '3', '3@gmail.com', 1, '1'),
(126, 'komang2', 'cbdef04ef5444eb8fecad9b49210ef5b', '13410100070', 'komang2', 'waka', '3', '3@gmail.com', 0, '1'),
(127, 'komang3', '928f5eda6247932ceef80c49cbda0bfc', '13410100071', 'komang3', 'wakel', '4', '4@gmail.com', 0, '1'),
(128, 'komang4', 'dde90e2b9136f81ac818dfa902373553', '13410100072', 'komang4', 'wakel', '5', '5@gmail.com', 0, '1'),
(129, 'komang5', 'e8f5c7174e14effbf1f5aac047393102', '13410100073', 'komang5', 'wakel', '6', '6@gmail.com', 0, '1'),
(130, 'komang6', '5ac9372ce33edfeb66a5cb10c16496e3', '13410100074', 'komang6', 'wakel', '7', '7@gmail.com', 0, '1'),
(131, 'admin', '21232f297a57a5a743894a0e4a801fc3', '13410100068', 'admin', 'admin', '1', '1@gmail.com', 1, '1'),
(132, 'admin', '21232f297a57a5a743894a0e4a801fc3', '13410100068', 'admin', 'admin', '1', '1@gmail.com', 0, '1'),
(133, 'komang1', 'c4373af13ebf8e3df93c2add6e05205a', '13410100069', 'komang1', 'kepsek', '2', '2@gmail.com', 0, '1'),
(134, 'komang2', 'cbdef04ef5444eb8fecad9b49210ef5b', '13410100070', 'komang2', 'waka', '3', '3@gmail.com', 1, '1'),
(135, 'komang2', 'cbdef04ef5444eb8fecad9b49210ef5b', '13410100070', 'komang2', 'waka', '3', '3@gmail.com', 0, '1'),
(136, 'komang3', '928f5eda6247932ceef80c49cbda0bfc', '13410100071', 'komang3', 'guru', '4', '4@gmail.com', 0, '1'),
(137, 'komang4', 'dde90e2b9136f81ac818dfa902373553', '13410100072', 'komang4', 'guru', '5', '5@gmail.com', 0, '1'),
(138, 'komang5', 'e8f5c7174e14effbf1f5aac047393102', '13410100073', 'komang5', 'guru', '6', '6@gmail.com', 0, '1'),
(139, 'komang6', '5ac9372ce33edfeb66a5cb10c16496e3', '13410100074', 'komang6', 'guru', '7', '7@gmail.com', 0, '1');

-- --------------------------------------------------------

--
-- Table structure for table `cbt_wali`
--

CREATE TABLE IF NOT EXISTS `cbt_wali` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `XGuruWali` varchar(10) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `XKodeAY` varchar(10) NOT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=2 ;

--
-- Dumping data for table `cbt_wali`
--

INSERT INTO `cbt_wali` (`ID`, `XGuruWali`, `XKodeAY`) VALUES
(1, 'wakel1', '2017/2018');
